...
static void my_application_activate(GApplication* application) {
  ...
  // Initialise layer shell and remove decorations BEFORE the window is realized.
  ax_layer_shell_configure_window(window);
  ...
  // Show window only after Flutter renders its first frame.
